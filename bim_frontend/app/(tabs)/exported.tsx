...
//   //   const fetchLogs = async () => {
//   //     try {
//   //       const response = await axios.get("http://192.168.1.14:8000/scan_logs/");
...
//   const handleDelete = async (id: number) => {
//     try {
//       await axios.delete(`http://192.168.1.14:8000/scan_logs/${id}`);
//       Alert.alert("Deleted", "Scan log deleted successfully");
//       fetchLogs();
//     } catch (err) {
//       console.error("Delete error:", err);
...
// const styles = StyleSheet.create({
//   listContainer: { paddingTop: 100, paddingLeft: 20, paddingRight: 20 },
//   item: {
//     padding: 16,
//     borderWidth: 1,
//     borderRadius: 10,
