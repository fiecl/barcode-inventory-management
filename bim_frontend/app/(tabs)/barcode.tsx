...
//     try {
//       const response = await axios.post("http://192.168.1.14:8000/products", {
//         name,
//         threshold: parseInt(threshold, 10),
//         quantity: parseInt(quantity, 10),
//       });
...
//         const response = await axios.post(
//           "http://192.168.1.14:8000/products/upload-barcode/",
//           formData,
//           { headers: { "Content-Type": "multipart/form-data" } }
//         );
...
//         <Button title="Upload / Take Barcode Photo" onPress={handleUploadBarcode} />
//       </View>
//     </View>
//   );
// }
